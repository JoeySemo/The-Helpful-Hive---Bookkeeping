        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-3">
              ...
              <h3 className="font-[family-name:var(--font-lora)] text-lg font-bold text-charcoal-gray mb-1">Community Roots</h3>
            ...
            <div className="text-center p-3">
              <div className="text-2xl mb-2">🤝</div>
              <h3 className="font-[family-name:var(--font-lora)] text-lg font-bold text-charcoal-gray mb-1">Trust &amp; Reliability</h3>
              <p className="font-[family-name:var(--font-montserrat)] text-sm text-neutral-600 leading-relaxed">
            ...
            <div className="text-center p-3">
              <div className="text-2xl mb-2">✨</div>
              <h3 className="font-[family-name:var(--font-lora)] text-lg font-bold text-charcoal-gray mb-1">Custom Care</h3>
              <p className="font-[family-name:var(--font-montserrat)] text-sm text-neutral-600 leading-relaxed">
