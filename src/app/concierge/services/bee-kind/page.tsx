...
export default function BeeKindPage() {
    const included = [
        { title: 'Dog Walking', description: '30-60 minute walks tailored to your pet' },
        { title: 'Potty Breaks', description: 'Quick visits for bathroom needs' },
        { title: 'Feeding & Water', description: 'Meal prep and fresh water refills' },
        { title: 'Vacation Check-ins', description: 'Daily visits while you\'re away' },
        { title: 'Pet Sitting', description: 'In-home care for extended stays' },
        { title: 'Basic Grooming', description: 'Brushing and simple care tasks' }
    ];
        ...
        <main style={{ minHeight: 'calc(100vh - 96px)', backgroundColor: '#f8f9fa' }}>
            ...
            <div style={{
                ...
                <p style={{ fontSize: '1.15rem', color: '#374151', maxWidth: '600px', margin: '0 auto' }}>
                    Loving care for your furry family members when you can't be there.
                </p>
            </div>
            ...
            <div style={{ maxWidth: '70rem', margin: '0 auto', padding: '3rem 2rem' }}>
                ...
                <section style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '0.75rem', border: '1px solid #e5e7eb', marginBottom: '3rem' }}>
                    ...
                    <div style={{ marginBottom: '1rem' }}>
                        <span style={{ fontSize: '2.25rem', fontWeight: 700, color: '#1f2937' }}>$20</span>
                        <span style={{ color: '#6b7280', fontSize: '1.25rem' }}>/visit</span>
                    </div>
                    <p style={{ color: '#6b7280', margin: 0 }}>
                        Perfect for pet owners who need reliable care for their beloved companions.
                    </p>
                </section>
