...
export default function BeeDonePage() {
    const included = [
        { title: 'Bathroom Deep Clean', description: 'Thorough scrubbing of all surfaces, fixtures, and floors' },
        { title: 'Kitchen Deep Clean', description: 'Appliances, counters, cabinets, and floor cleaning' },
        { title: 'Window Washing', description: 'Interior and exterior window cleaning' },
        { title: 'Laundry Services', description: 'Wash, dry, fold, and put away' },
        { title: 'General Cleaning', description: 'Dusting, vacuuming, and mopping' },
        { title: 'Move-In/Out Cleaning', description: 'Complete deep clean for transitions' }
    ];
        ...
        <main style={{ minHeight: 'calc(100vh - 96px)', backgroundColor: '#f8f9fa' }}>
            ...
            <div style={{
                ...
                <p style={{ fontSize: '1.25rem', color: '#374151', fontStyle: 'italic', marginBottom: '0.5rem' }}>
                    Household Chores & Cleaning Tasks
                </p>
                <p style={{ fontSize: '1.15rem', color: '#374151', maxWidth: '600px', margin: '0 auto' }}>
                    Let us handle the cleaning so you can focus on living.
                </p>
            </div>
            ...
            <div style={{ maxWidth: '70rem', margin: '0 auto', padding: '3rem 2rem' }}>
                ...
                <section style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '0.75rem', border: '1px solid #e5e7eb', marginBottom: '3rem' }}>
                    ...
                    <p style={{ color: '#6b7280', margin: 0 }}>
                        Perfect for busy families, professionals, or anyone who wants a spotless home without the hassle.
                    </p>
                </section>
