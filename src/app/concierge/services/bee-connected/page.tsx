...
export default function BeeConnectedPage() {
    const included = [
        { title: 'Holiday Decorating', description: 'Setup and takedown for all seasons' },
        { title: 'Donation Drop-offs', description: 'Sort and deliver to local charities' },
        { title: 'Event Support', description: 'Party prep, setup, and cleanup' },
        { title: 'Volunteer Help', description: 'Coordinate community involvement' },
        { title: 'Gift Wrapping', description: 'Beautiful presentation for any occasion' },
        { title: 'Seasonal Prep', description: 'Spring cleaning, winterizing, and more' }
    ];
        ...
        <main style={{ minHeight: 'calc(100vh - 96px)', backgroundColor: '#f8f9fa' }}>
            ...
            <div style={{
                ...
                <p style={{ fontSize: '1.15rem', color: '#374151', maxWidth: '600px', margin: '0 auto' }}>
                    Celebrate every season and stay connected to what matters.
                </p>
            </div>
            ...
            <div style={{ maxWidth: '70rem', margin: '0 auto', padding: '3rem 2rem' }}>
                ...
                <section style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '0.75rem', border: '1px solid #e5e7eb', marginBottom: '3rem' }}>
                    ...
                    <p style={{ color: '#6b7280', margin: 0 }}>
                        Perfect for families and individuals who want to enjoy the seasons without the stress.
                    </p>
                </section>
